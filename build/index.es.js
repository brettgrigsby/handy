...
var Hand = function (_a) {
    ...
    return (createElement(Fragment, null,
        createElement("div", { role: 'container', className: 'hand' }, transformations.map(function (ts, index) { return (createElement(Card, __assign({ key: "card=" + index, cardId: index, imgSrc: cards[index].imgSrc, cardText: cards[index].cardText, handleClick: cards[index].handleClick }, ts))); })),
