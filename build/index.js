...
var Hand = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { role: 'container', className: 'hand' }, transformations.map(function (ts, index) { return (React.createElement(Card, __assign({ key: "card=" + index, index: index, imgSrc: cards[index].imgSrc, cardText: cards[index].cardText }, ts))); })),
